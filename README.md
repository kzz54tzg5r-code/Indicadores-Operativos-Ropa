...
- Versión: `V53.2`
- Build: `Ventas y Análisis Comercial · menú lateral reforzado`
...
Consulte `CAMBIOS_V53.md`, `CAMBIOS_V53_1.md` y `CAMBIOS_V53_2.md` para conocer el nuevo flujo comercial y sus correcciones.
